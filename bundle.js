...
function mousePositionDriver() {
  return {
    ...
    ups: function ups() {
      return (0, _fromEvent2.default)(document, 'mouseup');
    }
  };
}

},{"xstream":127,"xstream/extra/fromEvent":126}],2:[function(require,module,exports){
'use strict';
...
function timeDriver() {
  var animation$ = _xstream2.default.create();
...
},{"performance-now":101,"raf":103,"xstream":127}],3:[function(require,module,exports){
'use strict';
...
var _timeDriver = require('./drivers/time-driver');

var _timeDriver2 = _interopRequireDefault(_timeDriver);

var _mouseDriver = require('./drivers/mouse-driver');
...
var center = (0, _vector2.default)({ x: innerWidth / 2, y: innerHeight / 2 });
...
function renderLinkBeingCreated(state, mousePosition) {
  ...
  var originNodePosition = state.nodes[state.addingLinkFrom].position;

  return [(0, _dom.h)('line', {
    attrs: {
...
function view(_ref) {
  var _ref2 = _slicedToArray(_ref, 3),
      state = _ref2[0],
      mousePosition = _ref2[1],
      hoverNode = _ref2[2];

  return (0, _dom.svg)({ attrs: { width: innerWidth, height: innerHeight } }, [(0, _dom.h)('defs', [(0, _dom.h)('marker#triangle', {
    attrs: {
      id: 'triangle',
      viewBox: '0 0 10 10',
      refX: '40',
    ...
    } }, hoverNode)].concat(_toConsumableArray(state.links.map(function (link) {
    return (0, _dom.h)('line', {
  ...
  })), _toConsumableArray(renderLinkBeingCreated(state, mousePosition)), _toConsumableArray(mapNodes(state.nodes, function (node) {
    return (0, _dom.h)('circle', {
      key: node.label,
      attrs: {
        key: node.label,
...
function update(delta, state) {
  ...
  state.links.forEach(function (link) {
    var fromNode = state.nodes[link.from];
    var toNode = state.nodes[link.to];

    var distance = fromNode.position.minus(toNode.position);
    var distanceInPixels = distance.pythag();

    var compressionMultiplier = Math.max(1, distanceInPixels / 100);

    var attractionForce = distance.normalize().times(compressionMultiplier).times(delta);
  ...
  mapNodes(state.nodes, function (node) {
    mapNodes(state.nodes, function (otherNode) {
      if (node === otherNode) {
        return;
      }

      var distance = node.position.minus(otherNode.position);
      var distanceInPixels = distance.pythag();

      var resistanceMultiplier = Math.max(0, (300 - distanceInPixels) / 150);

      var resistanceForce = distance.normalize().times(resistanceMultiplier).times(delta);
...
function startDragging(nodeElement, state) {
  ...
  var nodeKey = nodeElement.attributes.key.value;
...
function drag(position, state) {
  ...
  state.nodes[state.dragging].position = (0, _vector2.default)(position);
...
function Node(label, position) {
  return {
    label: label,
    position: (0, _vector2.default)(position)
  };
}
...
function makeNode(position, nodes) {
  ...
  var newNode = Node(key, position);

  return _extends({}, nodes, _defineProperty({}, key, newNode));
}

var nodes = ['a', 'b', 'c'].reduce(function (nodes, nodeName) {
  return makeNode(center.plus({ x: Math.random(), y: Math.random() }), nodes, nodeName);
}, {});

var links = [{ from: 'a', to: 'b' }, { from: 'a', to: 'c' }];
...
function main(_ref3) {
  ...
  var dblClick$ = DOM.select('svg').events('dblclick');

  var backgroundDblClick$ = dblClick$.filter(function (ev) {
    return ev.target.tagName === 'svg';
  });

  var nodeDblClick$ = dblClick$.filter(function (ev) {
    return ev.target.tagName === 'circle';
  });

  var placeNode$ = mousePosition$.map(function (position) {
    return backgroundDblClick$.mapTo(function (state) {
      return placeNode(position, state);
    });
  }).flatten();

  var startAddingLink$ = nodeDblClick$.map(function (ev) {
    return function (state) {
      return startAddingLink(ev.target, state);
    };
  });

  var startDragging$ = DOM.select('circle').events('mousedown').map(function (ev) {
    return function (state) {
      return startDragging(ev.target, state);
    };
  });

  var stopDragging$ = Mouse.ups().map(function (ev) {
    return stopDragging;
  });

  var drag$ = mousePosition$.map(function (position) {
    return function (state) {
      return drag(position, state);
    };
  });

  var update$ = Time.map(function (_ref4) {
    var delta = _ref4.delta;
    return delta / (1000 / 60);
  }).filter(function (delta) {
    return delta > 0 && delta < 10;
  }) // if you switch tab, you get huge deltas
  .map(function (delta) {
    return function (state) {
      return update(delta, state);
    };
  });

  var reducer$ = _xstream2.default.merge(update$, startDragging$, stopDragging$, drag$, placeNode$, startAddingLink$);

  var state$ = reducer$.fold(applyReducer, initialState);

  var hoverNode$ = DOM.select('circle').events('mouseover').map(function (ev) {
    return ev.target.attributes.key.value;
  }).startWith('');

  return {
    DOM: _xstream2.default.combine(state$, mousePosition$, hoverNode$).map(view)
  };
}

var drivers = {
  DOM: (0, _dom.makeDOMDriver)('.app'),
  Time: _timeDriver2.default,
  Mouse: _mouseDriver2.default
};

(0, _xstreamRun.run)(main, drivers);

},{"./drivers/mouse-driver":1,"./drivers/time-driver":2,"./vector":128,"@cycle/dom":16,"@cycle/xstream-run":26,"xstream":127}],4:[function(require,module,exports){
"use strict";
...
},{"./fromEvent":13,"@cycle/xstream-adapter":25,"xstream":127}],6:[function(require,module,exports){
"use strict";
var xstream_1 = require('xstream');
var xstream_adapter_1 = require('@cycle/xstream-adapter');
var fromEvent_1 = require('./fromEvent');
...
},{"./fromEvent":13,"@cycle/xstream-adapter":25,"xstream":127}],7:[function(require,module,exports){
"use strict";
...
},{"./ScopeChecker":11,"./utils":24,"matches-selector":100}],8:[function(require,module,exports){
"use strict";
var ScopeChecker_1 = require('./ScopeChecker');
var utils_1 = require('./utils');
var matchesSelector;
...
},{"./ScopeChecker":11,"./utils":24,"matches-selector":100}],9:[function(require,module,exports){
"use strict";
var xstream_1 = require('xstream');
var xstream_adapter_1 = require('@cycle/xstream-adapter');
...
},{"@cycle/xstream-adapter":25,"xstream":127}],10:[function(require,module,exports){
"use strict";
var xstream_adapter_1 = require('@cycle/xstream-adapter');
...
},{"./BodyDOMSource":5,"./DocumentDOMSource":6,"./ElementFinder":7,"./EventDelegator":8,"./fromEvent":13,"./isolate":17,"./utils":24,"@cycle/xstream-adapter":25,"matches-selector":100,"xstream":127}],11:[function(require,module,exports){
"use strict";
...
},{"./hyperscript":15,"snabbdom-selector/lib/classNameFromVNode":104,"snabbdom-selector/lib/selectorParser":105}],13:[function(require,module,exports){
"use strict";
var xstream_1 = require('xstream');
...
},{"xstream":127}],14:[function(require,module,exports){
"use strict";
var hyperscript_1 = require('./hyperscript');
...
},{"./hyperscript":15}],15:[function(require,module,exports){
"use strict";
...
},{"snabbdom/is":115,"snabbdom/vnode":124}],16:[function(require,module,exports){
"use strict";
...
},{"./hyperscript":15,"./hyperscript-helpers":14,"./makeDOMDriver":19,"./makeHTMLDriver":20,"./mockDOMSource":21,"snabbdom/thunk":123}],17:[function(require,module,exports){
"use strict";
var utils_1 = require('./utils');
...
},{"es6-map":69}],19:[function(require,module,exports){
"use strict";
...
},{"./MainDOMSource":10,"./VNodeWrapper":12,"./isolateModule":18,"./modules":22,"./transposition":23,"./utils":24,"@cycle/xstream-adapter":25,"es6-map":69,"snabbdom":122,"xstream":127}],20:[function(require,module,exports){
"use strict";
var xstream_adapter_1 = require('@cycle/xstream-adapter');
var transposition_1 = require('./transposition');
...
},{"./HTMLSource":9,"./transposition":23,"@cycle/xstream-adapter":25,"snabbdom-to-html":107}],21:[function(require,module,exports){
"use strict";
var xstream_adapter_1 = require('@cycle/xstream-adapter');
var xstream_1 = require('xstream');
...
},{"@cycle/xstream-adapter":25,"xstream":127}],22:[function(require,module,exports){
"use strict";
...
},{"snabbdom/modules/attributes":116,"snabbdom/modules/class":117,"snabbdom/modules/eventlisteners":118,"snabbdom/modules/hero":119,"snabbdom/modules/props":120,"snabbdom/modules/style":121}],23:[function(require,module,exports){
"use strict";
var xstream_adapter_1 = require('@cycle/xstream-adapter');
var xstream_1 = require('xstream');
...
},{"@cycle/xstream-adapter":25,"xstream":127}],24:[function(require,module,exports){
"use strict";
...
},{"@cycle/base":4,"@cycle/xstream-adapter":25}],27:[function(require,module,exports){
/*!
...
},{"performance-now":101}],104:[function(require,module,exports){
'use strict';
...
},{"browser-split":27}],106:[function(require,module,exports){
...
},{"../parse-selector":111,"lodash.escape":91,"lodash.forown":92,"lodash.union":98}],110:[function(require,module,exports){
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
},{"lodash.escape":91,"lodash.forown":92,"lodash.kebabcase":95}],111:[function(require,module,exports){
...
},{"browser-split":27}],112:[function(require,module,exports){
...
},{"../core":125}],127:[function(require,module,exports){
"use strict";
var core_1 = require('./core');
...
},{"./core":125}],128:[function(require,module,exports){
"use strict";
